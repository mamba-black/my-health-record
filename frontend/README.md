...
There are two empty spaces in the MIT license you need to fill out: `` and `Hector Miuler Malpica Gallegos <miuler@gmail.com>`.

## tailwindcss

`tailwindcss -i ./tailwind.css -o ./tailwind-output.css --watch`
