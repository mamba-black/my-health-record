<script lang="ts">
  ...
  let patient: Patient = $props();
  let first_name = patient.firstName;
  let last_name = patient.lastName;
  let second_name = patient.secondLastName;
...
<div class="lg:wa-7/12 lg:justify-around">
  <form onreset={reset_handle} onsubmit={submit_handle} >
